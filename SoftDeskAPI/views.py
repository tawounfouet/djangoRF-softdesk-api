...
from .permissions import IsContributorOrReadOnly, IsAuthorOrReadOnly, IsOwnerOrContributorOrReadOnly
...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated,IsOwnerOrContributorOrReadOnly, IsContributorOrReadOnly, IsAuthorOrReadOnly]
...
class ContributorViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, IsContributorOrReadOnly, IsOwnerOrContributorOrReadOnly, IsAuthorOrReadOnly]
